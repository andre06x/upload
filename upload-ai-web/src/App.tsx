    ...
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm text-muted-foreground">Desenvolvido com s2</span>
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 pag-4">
          <div className="grid grid-rows-2 gap-4 flex-1">
            <Textarea
              className="resize-none p-4 leading-relaxed"
              placeholder="Inclua a prompt para o IA..."
              value={input}
          ...
          <p className="text-sm text-muted-foreground">
            ...
            <code className="text-violet-400">{"transp"}</code> no seu prompt para
